...
knitr::read_chunk(here("analysis","01_count_SS_uncertain_dates.R"))
```
...
```{r plot_geom_obs, echo = FALSE, fig.width=7, fig.height=5, fig.path=here("analysis","results","/")}
<<plot_geom_obs>>
```
...
```{r plot_tobs, echo = FALSE, fig.width=10, fig.height=6, out.width="100%", fig.path=here("analysis","results","/")}
<<plot_tobs>>
```
